...
fpa0 = -7.1; % deg
alt0 = 500e3; % m
tgt_ap = 430000e3; % unused
tgt_pe = 2500e3 + in.p.r_e; % unused
...
in.v.gnc.g.p_bank_a.fpa_e = ... % entry flight path angle
    atan2(norm(cross(-in.s.traj.r_pci_ini,in.s.traj.v_pci_ini)),...
          dot(-in.s.traj.r_pci_ini,in.s.traj.v_pci_ini))-pi/2;
in.v.gnc.g.p_bank_a.fpa_f = in.v.gnc.g.p_bank_a.fpa_e;
...
in.v.gnc.g.p_bank_a.x_f = log((in.v.gnc.g.p_bank_a.Ve/vf)^2);
