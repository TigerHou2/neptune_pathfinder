...
in.p = get_planetary_data( 2, 2 ); % Load settings for Earth, table atm model
...
in.v.gnc.g.p_sej_a.tgt_apoapse = 400e3; % m
in.v.gnc.g.p_sej_a.tol_apoapse = 10e3; % m
in.v.gnc.g.p_sej_a.alt_min = 0; % m
in.v.gnc.g.p_sej_a.alt_max = 150e3; % m
...
in.v.gnc.g.p_sej_a.t_jettison_ini = 100; % s
