...
switch planet
    ...
    case 1 % Venus
        ...
        p.mu = 3.249e14; % gravitational parameter, m^3/s^2
        ...
        temp = load(['.' filesep 'data' filesep 'atm_venus.mat']);
...
%         p.k = 1.7623e-4; % Sutton-Graves heating coefficient, kg^0.5/m
        ...
        temp = load(['.' filesep 'data' filesep 'atm_earth.mat']);
        p.atm.table = temp.table; % atmosphere table, multi   
    ...
    case 3 % Mars
        ...
        temp = load(['.' filesep 'data' filesep 'atm_mars.mat']);
        p.atm.table = temp.table; % atmosphere table, multi   
    ...
    case 6 % Titan
        ...
        p.atm.temp_ref = 100; % reference temperature, K
        temp = load(['.' filesep 'data' filesep 'atm_titan.mat']);
        p.atm.table = temp.table; % atmosphere table, multi   
    ...
    case 8 % Neptune
        ...
        p.atm.pres_ref = 101400; % surface pressure, N/m^2       
        p.atm.temp_ref = 100; % reference temperature, K
        temp = load(['.' filesep 'data' filesep 'atm_neptune.mat']);
        p.atm.table = temp.table; % atmosphere table, multi   
