...
sej_a = aa_define_g_sej_a; % Single-event-jettison aerocapture guidance (drag modulation)
...
bank_a = aa_define_g_bank_a; % bank angle modulation for aerocapture
pathfinder = aa_define_g_pathfinder; % Neptune pathfinder guidance
